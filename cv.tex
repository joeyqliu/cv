...
\begin{tabular}{p{0.97\textwidth}}
  I'm a software engineer passionate about the ins and outs of platform engineering. My experience has been in
  managing large scale deployments of infrastructure as code platforms as well as working in closely in various
  cloud platforms such as AWS and GCP. I love enabling other engineers to deploy infrastructure and enjoy bridging
...
\begin{longtable}{p{3.2cm}|p{14.1cm}}
  \joblogcurrent{Software Engineer II, Cloud Engineering}{Handshake}{San Francisco, CA}{2023-05-01}{%
    • Researched, POC'ed, and orchestrated our migration of 200+ terraform workspaces from Terraform Cloud to Spacelift in under 2 months, saving \$100k+ / year in SaaS costs.\\%
    • Identified inefficiencies in our terraform codebase and worked across all engineering teams to standardize and unify our repository,
    saving engineers 2+ hours a week in deploying infrastructure.\\%
    • Implemented workload identity federation across all GCP projects which enables dynamic credential generation while reducing
    250+ outdated service account keys.\\%
  }{}
...
\begin{tabular}{r|l}
  ...
  \textsc{Product management:}& Scrum -- Kanban -- Jira -- Confluence -- Linear\\
